# go-ruby-nokogiri documentation

**Pure-Go (CGO=0) MRI-faithful Ruby nokogiri**

`go-ruby-nokogiri/nokogiri` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `nokogiri`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `nokogiri`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`nokogiri`](https://github.com/go-ruby-nokogiri/nokogiri) | the library — Ruby's `nokogiri` in pure Go |
| [`docs`](https://github.com/go-ruby-nokogiri/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-nokogiri.github.io`](https://github.com/go-ruby-nokogiri/go-ruby-nokogiri.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-nokogiri/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-nokogiri/nokogiri](https://github.com/go-ruby-nokogiri/nokogiri).
