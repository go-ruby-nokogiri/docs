...
The public API lives at the module root (`github.com/go-ruby-nokogiri/nokogiri`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `nokogiri`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-nokogiri/nokogiri](https://pkg.go.dev/github.com/go-ruby-nokogiri/nokogiri)**

The module's [README](https://github.com/go-ruby-nokogiri/nokogiri#readme) carries worked
