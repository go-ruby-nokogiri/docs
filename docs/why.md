...
`go-ruby-nokogiri/nokogiri` reimplements Ruby's `nokogiri` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-nokogiri/nokogiri` directly, with no Ruby runtime;
